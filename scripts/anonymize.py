...
# 常用城市 → 省份 映射（数据只有"城市"列时自动补省份，用于中国地图省→市钻取）
CITY_PROV = {
    # 直辖市
    '北京': '北京市', '上海': '上海市', '天津': '天津市', '重庆': '重庆市',
    # 河北
    '石家庄': '河北省', '唐山': '河北省', '秦皇岛': '河北省', '邯郸': '河北省', '保定': '河北省', '廊坊': '河北省',
    # 山西
    ...
    # 黑龙江
    '哈尔滨': '黑龙江省', '齐齐哈尔': '黑龙江省', '大庆': '黑龙江省', '牡丹江': '黑龙江省',
    # 江苏
    '南京': '江苏省', '苏州': '江苏省', '无锡': '江苏省', '常州': '江苏省', '南通': '江苏省',
    '徐州': '江苏省', '扬州': '江苏省', '镇江': '江苏省', '泰州': '江苏省', '盐城': '江苏省', '淮安': '江苏省',
    # 浙江
    '杭州': '浙江省', '宁波': '浙江省', '温州': '浙江省', '嘉兴': '浙江省', '湖州': '浙江省',
    '绍兴': '浙江省', '金华': '浙江省', '台州': '浙江省', '义乌': '浙江省', '衢州': '浙江省',
    # 安徽
    '合肥': '安徽省', '芜湖': '安徽省', '蚌埠': '安徽省', '马鞍山': '安徽省', '阜阳': '安徽省', '安庆': '安徽省',
    # 福建
    '福州': '福建省', '厦门': '福建省', '泉州': '福建省', '漳州': '福建省', '莆田': '福建省', '宁德': '福建省',
    # 江西
    '南昌': '江西省', '赣州': '江西省', '九江': '江西省', '上饶': '江西省', '宜春': '江西省',
    # 山东
    '济南': '山东省', '青岛': '山东省', '烟台': '山东省', '潍坊': '山东省', '淄博': '山东省',
    '临沂': '山东省', '威海': '山东省', '济宁': '山东省', '泰安': '山东省', '日照': '山东省', '枣庄': '山东省',
    # 河南
    '郑州': '河南省', '洛阳': '河南省', '开封': '河南省', '南阳': '河南省', '新乡': '河南省',
    '信阳': '河南省', '安阳': '河南省', '许昌': '河南省', '商丘': '河南省',
    # 湖北
    '武汉': '湖北省', '宜昌': '湖北省', '襄阳': '湖北省', '荆州': '湖北省', '黄石': '湖北省', '十堰': '湖北省',
    # 湖南
    '长沙': '湖南省', '株洲': '湖南省', '湘潭': '湖南省', '衡阳': '湖南省', '岳阳': '湖南省', '常德': '湖南省',
    # 广东
    '广州': '广东省', '深圳': '广东省', '珠海': '广东省', '佛山': '广东省', '东莞': '广东省',
    '中山': '广东省', '惠州': '广东省', '江门': '广东省', '汕头': '广东省', '湛江': '广东省', '肇庆': '广东省',
    # 广西
    '南宁': '广西壮族自治区', '桂林': '广西壮族自治区', '柳州': '广西壮族自治区', '北海': '广西壮族自治区',
    # 海南
    '海口': '海南省', '三亚': '海南省', '儋州': '海南省',
    # 四川
    '成都': '四川省', '绵阳': '四川省', '德阳': '四川省', '南充': '四川省', '宜宾': '四川省',
    '泸州': '四川省', '乐山': '四川省', '达州': '四川省', '眉山': '四川省', '遂宁': '四川省',
    # 贵州
    '贵阳': '贵州省', '遵义': '贵州省', '六盘水': '贵州省', '毕节': '贵州省',
    # 云南
    '昆明': '云南省', '大理': '云南省', '丽江': '云南省', '曲靖': '云南省', '玉溪': '云南省', '西双版纳': '云南省',
    # 西藏
    '拉萨': '西藏自治区', '日喀则': '西藏自治区',
    # 陕西
    '西安': '陕西省', '咸阳': '陕西省', '宝鸡': '陕西省', '榆林': '陕西省', '渭南': '陕西省', '汉中': '陕西省',
    # 甘肃
    '兰州': '甘肃省', '天水': '甘肃省', '酒泉': '甘肃省', '嘉峪关': '甘肃省',
    # 青海
    '西宁': '青海省', '海东': '青海省',
    # 宁夏
    '银川': '宁夏回族自治区', '吴忠': '宁夏回族自治区', '石嘴山': '宁夏回族自治区',
    # 新疆
    '乌鲁木齐': '新疆维吾尔自治区', '喀什': '新疆维吾尔自治区', '伊犁': '新疆维吾尔自治区', '克拉玛依': '新疆维吾尔自治区',
    # 港澳台（按中国行政区划）
...
def build(records, level='L2', scale=1.0, date_shift=0, mapping=None,
    ...
    if any('country' in r for r in out):
        ...
        if rk == ['city']:
            # 只有"城市"列 → 用内置城市→省份映射自动补省份，支持中国地图省→市钻取
            filled = 0
            for r in out:
                if r.get('prov'):
                    continue
                ...
                if not c:
                    continue
                p = CITY_PROV.get(c) or CITY_PROV.get(c.rstrip('市'))
                if p:
                    r['prov'] = p
                    filled += 1
            if filled:
                rk = ['prov', 'city']
                print('  🗺 检测到城市列，已自动推断省份 %d 行（中国地图省→市钻取可用）' % filled)
        if rk:
            meta['regionKeys'] = rk
